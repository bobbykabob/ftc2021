...
public class redwarehouse extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        hardware robit = new hardware(hardwareMap, hardware.color.RED);

        SampleMecanumDrive drive = new SampleMecanumDrive(hardwareMap);
        Pose2d startPose = new Pose2d(12, -66, Math.toRadians(270));
        Pose2d hubPose = new Pose2d(-16, -40, Math.toRadians(90));
            ...
            if (cyclepos == cyclePos.finding) {
                ...
                if ((30000 - (currentTime - startTime)) < 5000) {
                    ...
                    drive.followTrajectorySequenceAsync(drive.trajectorySequenceBuilder(currentPose)
                            ...
                            .splineTo(new Vector2d(25, -68), Math.toRadians(180))
                            .UNSTABLE_addDisplacementMarkerOffset(0, ()-> {
                                robit.outtake.setOuttake(outtake.outtakePos.OUT_OPEN);
                            })

                            .splineTo(new Vector2d(-18, -45), Math.toRadians(90), SampleMecanumDrive.getVelocityConstraint(40, 40, DriveConstants.TRACK_WIDTH),
                                    SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                            .splineTo(new Vector2d(-18, -40), Math.toRadians(90), SampleMecanumDrive.getVelocityConstraint(20, 20, DriveConstants.TRACK_WIDTH),
                                    SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                            ...
                            .splineToConstantHeading(new Vector2d(55, -68), Math.toRadians(0), SampleMecanumDrive.getVelocityConstraint(5, 5, DriveConstants.TRACK_WIDTH),
                                    SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                            .build()
